...
public class C01_Screenshot1 extends TestBase {
    /*
    Seleniium da tum ekran goruntusu nasil alinir?
    ...
    public void fullPageScreenshotTest() throws IOException {
        ...
        //Note: kayit ismini dinamik yapmak icin date objesi olusturup tarihi belirledik
       // String path = System.getProperty("user.dir")+"test-output/EkranGoruntuleri/image.png";
        ...
        //3.Ekran goruntusu ile soyayi birlestirerek kaydedecegiz.
